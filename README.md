...
<p align="center">
  <img width="300" height="500" src="https://i.imgur.com/jeI66aJ.jpg">
    <img width="300" height="500" src="https://i.imgur.com/MgZUzxI.jpg">
</p>
Once entered as a Donor mode, the following screen will be selected in which we can choose what type of material we are going to donate, for example:
...
Upon entering as a receiving user, this will be your main screen, where you can see the publications with their corresponding data, such as your photo, the name of the product, the faculty,etc.
You will have another button called "Desire" when you select send a notification to the owner of the product, at the time of selecting it will be sent to the wish list to control the desired item.
...
Once the type of material is selected, the following screen will be displayed on which we have to enter the image of the product to donate, the faculty to which the product belongs, the amount of items to donate, the time at which the donor can deliver the product, the place where you can deliver the product and a detailed product description
